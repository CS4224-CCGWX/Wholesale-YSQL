...
public class PreparedQueries {
    ...
    public final static String getStockQty = "SELECT S_QUANTITY, S_YTD "
            + "FROM stock "
    ...
    public final static String getItemPriceAndName =  "SELECT I_PRICE, I_NAME "
            + "FROM item "
            + "WHERE I_ID = ?;";
    ...
    public final static String getWarehouseTax =  "SELECT W_TAX "
            + "FROM warehouse "
            + "WHERE W_ID = ?;";
    ...
    public final static String updateDistrictYearToDateAmount =  "UPDATE district "
            + "SET D_YTD = ? "
            + "WHERE D_W_ID = ? AND D_ID = ?;";
