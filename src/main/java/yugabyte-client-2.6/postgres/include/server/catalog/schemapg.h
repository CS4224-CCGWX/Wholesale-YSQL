...
#define Schema_pg_tablegroup \
{ 8000, {"grpname"}, 19, -1, NAMEDATALEN, 1, 0, -1, -1, false, 'p', 'c', true, false, false, '\0', false, true, 0, 0 }, \
{ 8000, {"grpowner"}, 26, -1, 4, 2, 0, -1, -1, true, 'p', 'i', true, false, false, '\0', false, true, 0, 0 }, \
{ 8000, {"grpacl"}, 1034, -1, -1, 3, 1, -1, -1, false, 'x', 'i', false, false, false, '\0', false, true, 0, 0 }, \
{ 8000, {"grpoptions"}, 1009, -1, -1, 4, 1, -1, -1, false, 'x', 'i', false, false, false, '\0', false, true, 0, 100 }
...
#define Schema_pg_yb_catalog_version \
{ 8010, {"db_oid"}, 26, -1, 4, 1, 0, -1, -1, true, 'p', 'i', true, false, false, '\0', false, true, 0, 0 }, \
{ 8010, {"current_version"}, 20, -1, 8, 2, 0, -1, -1, FLOAT8PASSBYVAL, 'p', 'd', true, false, false, '\0', false, true, 0, 0 }, \
{ 8010, {"last_breaking_version"}, 20, -1, 8, 3, 0, -1, -1, FLOAT8PASSBYVAL, 'p', 'd', true, false, false, '\0', false, true, 0, 0 }
