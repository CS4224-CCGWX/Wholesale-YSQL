...
#define PG_VERSION "11.2-YB-2.6.1.0-b0"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 110002

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 11.2-YB-2.6.1.0-b0 on x86_64-apple-darwin20.4.0, compiled by Apple clang version 11.0.3 (clang-1103.0.32.62), 64-bit"
