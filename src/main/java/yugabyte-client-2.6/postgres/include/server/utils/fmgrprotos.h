...
extern Datum yb_getrusage(PG_FUNCTION_ARGS);
extern Datum yb_mem_usage(PG_FUNCTION_ARGS);
extern Datum yb_mem_usage_kb(PG_FUNCTION_ARGS);
extern Datum yb_mem_usage_sql(PG_FUNCTION_ARGS);
extern Datum yb_mem_usage_sql_b(PG_FUNCTION_ARGS);
extern Datum yb_mem_usage_sql_kb(PG_FUNCTION_ARGS);
extern Datum jsonb_set_lax(PG_FUNCTION_ARGS);
extern Datum ybcinhandler(PG_FUNCTION_ARGS);
